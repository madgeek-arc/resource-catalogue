...
import gr.uoa.di.madgik.service.MigrationService;
...
//            service.setStatus(status.getKey());
    ...
    public ResponseEntity<List<gr.uoa.di.madgik.dto.Value>> providerIdToNameMap(String catalogueId) {
        List<gr.uoa.di.madgik.dto.Value> allProviders = new ArrayList<>();
        // fetch catalogueId related non-public Providers
        List<gr.uoa.di.madgik.dto.Value> catalogueRelatedProviders = providerService
                ...
                .map(c -> new gr.uoa.di.madgik.dto.Value(c.getId(), c.getName()))
                .collect(Collectors.toList());
        // fetch non-catalogueId related public Providers
        List<gr.uoa.di.madgik.dto.Value> publicProviders = providerService
