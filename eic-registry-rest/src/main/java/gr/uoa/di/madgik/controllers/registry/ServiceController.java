...
import gr.uoa.di.madgik.service.GenericResourceService;
...
public class ServiceController {
    ...
    public ResponseEntity<List<gr.uoa.di.madgik.dto.Value>> resourceIdToNameMap(@RequestParam String catalogueId) {
        List<gr.uoa.di.madgik.dto.Value> allResources = new ArrayList<>();
        // fetch catalogueId related non-public Resources

        List<gr.uoa.di.madgik.dto.Value> catalogueRelatedServices = genericResourceService
                ...
                .map(c -> new gr.uoa.di.madgik.dto.Value(c.getId(), c.getService().getResourceOrganisation() + " - " + c.getService().getName()))
                .collect(Collectors.toList());
        List<gr.uoa.di.madgik.dto.Value> catalogueRelatedTrainingResources = genericResourceService
                ...
                .map(c -> new gr.uoa.di.madgik.dto.Value(c.getId(), c.getTrainingResource().getResourceOrganisation() + " - " + c.getTrainingResource().getTitle()))
                .collect(Collectors.toList());
        // fetch non-catalogueId related public Resources
        List<gr.uoa.di.madgik.dto.Value> publicServices = genericResourceService
                ...
                .map(c -> new gr.uoa.di.madgik.dto.Value(c.getId(), c.getService().getResourceOrganisation() + " - " + c.getService().getName()))
                .collect(Collectors.toList());
        List<gr.uoa.di.madgik.dto.Value> publicTrainingResources = genericResourceService
