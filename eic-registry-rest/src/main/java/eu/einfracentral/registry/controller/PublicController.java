...
public class PublicController {
    ...
    public ResponseEntity<Provider> getPublicProvider(@PathVariable("id") String id, @ApiIgnore Authentication auth) {
...
//    @ApiOperation(value = "Returns the Public Provider bundle with the given id.")
    ...
    public ResponseEntity<ProviderBundle> getPublicProviderBundle(@PathVariable("id") String id, @ApiIgnore Authentication auth) {
        ProviderBundle providerBundle = providerService.get(id);
        if (providerBundle.getMetadata().isPublished()){
