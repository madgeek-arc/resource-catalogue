...
@Api(description = "Operations for Resources", tags = {"resource-controller"})
public class EOSCResourceController {

    private static final Logger logger = LogManager.getLogger(EOSCResourceController.class);
    ...
    @Autowired
    EOSCResourceController(InfraServiceService<InfraService, InfraService> service,
