...
public class StatisticsController {
    ...
    public ResponseEntity<Map<String, Integer>> visits(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> externalsAlias(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> externals(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> internals(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> favourites(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Float>> ratings(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> pVisits(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> pExternals(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> pExternalsAlias(@PathVariable("id") String id, Authentication jwt) {
        return new ResponseEntity<>(statisticsService.pExternals(id), HttpStatus.OK);
    }

    @RequestMapping(path = "provider/internals/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<Map<String, Integer>> pInternals(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Integer>> pFavourites(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Float>> pRatings(@PathVariable("id") String id, Authentication jwt) {
    ...
    public ResponseEntity<Map<String, Float>> pVisitation(@PathVariable("id") String id, Authentication jwt) {
