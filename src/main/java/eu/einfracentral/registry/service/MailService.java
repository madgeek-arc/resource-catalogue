...
//    @PropertySource("classpath:application.properties")
    ...
    public MailService() {
        ...
        jmp.put("mail.activate.text", "Please visit http://localhost:8080/eic-registry/user/activate/");
        jmp.put("mail.reset.subject", "[eInfraCentral] Reset your password");
        jmp.put("mail.reset.text", "Please visit http://localhost:8080/eic-registry/user/reset/");
