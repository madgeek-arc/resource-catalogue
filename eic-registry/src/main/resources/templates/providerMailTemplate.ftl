...
You have applied for registering [${providerBundle.provider.name}] - ([${providerBundle.provider.id}]) as a new ${project} Provider in the ${project} Portal.
Your application has been approved and you may proceed with providing one of your Resources ${endpoint}/myServiceProviders ,which can help us assess the type of Resources you want to offer.
...
Thank you for your interest in becoming a member of the ${project} Portal.
    <#else>
Your Resource Provider [${providerBundle.provider.name}] - ([${providerBundle.provider.id}]) has been set to inactive. For any further clarifications please contact ${registrationEmail}.
    </#if>
</#if>
