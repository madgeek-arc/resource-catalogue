...
<#if action == "put">
    Service with id: [${datasourceBundle.datasource.serviceId}] of the [${datasourceBundle.catalogueId}] Catalogue updated its Datasource extension with id: [${datasourceBundle.datasource.id}]
