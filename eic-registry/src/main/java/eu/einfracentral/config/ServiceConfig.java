...
@Configuration
@ComponentScan(value = {
        "eu.openminted.registry.core.configuration",
        "eu.openminted.registry.core.backup",
        "eu.openminted.registry.core.index",
...
public class ServiceConfig extends AbstractHttpSessionApplicationInitializer {
    ...
    JAXBContext eicJAXBContext() throws JAXBException {
        return JAXBContext.newInstance(Event.class, Provider.class, DynamicField.class, ArrayList.class,
