...
//                            logger.warn(String.format("Favs: %s - Unfavs: %s", totalDocCounts[1], totalDocCounts[0]));
    ...
    public Map<String, Float> providerRatings(String id, Interval by) {
        Map<String, Float> providerRatings = infraServiceManager.getResources(id)
                .stream()
    ...
    public Map<String, Integer> providerFavourites(String id, Interval by) {
        Map<String, Integer> providerFavorites = infraServiceManager.getResources(id)
                .stream()
    ...
    public Map<String, Integer> providerAddToProject(String id, Interval by) {
        Map<String, Integer> providerAddToProject = infraServiceManager.getResources(id)
                .stream()
...
//        return new HashMap<>();
    ...
    public Map<String, Integer> providerVisits(String id, Interval by) {
        ...
        for (Service service : infraServiceManager.getResources(id)){
    ...
    public Map<String, Float> providerVisitation(String id, Interval by) {
        Map<String, Integer> counts = infraServiceManager.getResources(id).stream().collect(Collectors.toMap(
                Service::getName,
