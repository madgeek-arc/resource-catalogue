...
//
//    private final ServiceBundleService<DatasourceBundle> serviceBundleService;
...
//
//    @Autowired
//    public PendingDatasourceManager(ServiceBundleService<DatasourceBundle> serviceBundleService,
...
//        List<DatasourceBundle> resourceList = serviceBundleService.getAll(ff, auth).getResults();
...
//        DatasourceBundle datasourceBundle = serviceBundleService.get(datasourceId);
//        Resource resource = serviceBundleService.getResource(datasourceBundle.getDatasource().getId(), catalogueName);
...
//        serviceBundleService.validate(datasourceBundle);
//
//        // update loggingInfo
...
//
//        try {
//            datasourceBundle = serviceBundleService.update(datasourceBundle, auth);
