...
public class FieldValidator {
    ...
    public void validate(Object o) throws IllegalAccessException {
        ...
        validateFields(o);
        if (o.getClass().getSuperclass() != null && (o.getClass().getSuperclass().getCanonicalName().contains("gr.uoa.di.madgik.domain.Bundle"))) {
            try {
                    ...
                    if (annotation.containsResourceId()) {
                        ...
                        throw new ValidationException(
                                String.format("Field '%s' should contain the ID of an existing Provider",
                                        field.getName()));
                    } else if ((gr.uoa.di.madgik.domain.Service.class.equals(annotation.idClass())
