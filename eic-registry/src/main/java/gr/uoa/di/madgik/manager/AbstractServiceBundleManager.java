...
import gr.uoa.di.madgik.utils.TextUtils;
...
public abstract class AbstractServiceBundleManager<T extends ServiceBundle> extends AbstractGenericService<T> implements ServiceBundleService<T> {
    ...
    @Override
    @CacheEvict(cacheNames = {CacheConfig.CACHE_VISITS, CacheConfig.CACHE_PROVIDERS, CacheConfig.CACHE_FEATURED}, allEntries = true)
