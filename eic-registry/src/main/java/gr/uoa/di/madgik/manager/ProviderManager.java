...
import gr.uoa.di.madgik.validators.FieldValidator;
...
import static gr.uoa.di.madgik.config.CacheConfig.*;
import static gr.uoa.di.madgik.utils.VocabularyValidationUtils.validateMerilScientificDomains;
import static gr.uoa.di.madgik.utils.VocabularyValidationUtils.validateScientificDomains;
...
public class ProviderManager extends ResourceManager<ProviderBundle> implements ProviderService<ProviderBundle, Authentication> {
    ...
    private ProviderBundle getWithCatalogue(String id, String catalogueId) {
        ...
        if (resource == null) {
            throw new gr.uoa.di.madgik.exception.ResourceNotFoundException(String.format("Could not find provider with id: %s and catalogueId: %s", id, catalogueId));
        }
    ...
    public ProviderBundle get(String catalogueId, String providerId, Authentication auth) {
        ...
        if (providerBundle == null) {
            throw new gr.uoa.di.madgik.exception.ResourceNotFoundException(
