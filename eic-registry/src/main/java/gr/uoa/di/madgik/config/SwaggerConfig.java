...
//                .alternateTypeRules(newRule(typeResolver.arrayType(XMLGregorianCalendar.class), typeResolver.arrayType(String.class)))
                ...
                .select()
                .apis(isLocalhost ? RequestHandlerSelectors.basePackage("gr.uoa.di.madgik") :
...
//                .license("NAME")
    ...
    private String getVersion() {
        String ret = null;
        try (InputStream in = getClass().getResourceAsStream("/META-INF/maven/gr.uoa.di.madgik/eic-registry-model/pom.properties")) {
