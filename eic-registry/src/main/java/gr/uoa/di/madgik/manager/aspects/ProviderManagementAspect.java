...
import gr.uoa.di.madgik.domain.interoperabilityRecord.configurationTemplates.ConfigurationTemplateInstanceBundle;
import gr.uoa.di.madgik.exception.ResourceException;
import gr.uoa.di.madgik.exception.ResourceNotFoundException;
import gr.uoa.di.madgik.manager.*;
...
public class ProviderManagementAspect {
    ...
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.PendingServiceManager.transformToActive(..)) " +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.addResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.updateResource(..))",
    ...
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.addResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.updateResource(..))",
    ...
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ProviderManager.verifyProvider(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ProviderManager.add(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.PendingProviderManager.transformToActive(..))",
    ...
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.CatalogueManager.verifyCatalogue(..)) " +
            "|| execution(* gr.uoa.di.madgik.manager.CatalogueManager.add(..))",
    ...
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.verifyResource(..))",
            returning = "serviceBundle")
    ...
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.verifyResource(..))",
            returning = "trainingResourceBundle")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ProviderManager.add(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ProviderManager.verifyProvider(..))",
            returning = "providerBundle")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ProviderManager.update(..)) " +
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ProviderManager.publish(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ProviderManager.verifyProvider(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ProviderManager.suspend(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ProviderManager.auditProvider(..))",
            returning = "providerBundle")
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.ProviderManager.delete(..))")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.addResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.verifyResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.PendingServiceManager.transformToActive(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.changeProvider(..))",
            returning = "serviceBundle")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.addResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.verifyResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.changeProvider(..))",
            returning = "trainingResourceBundle")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.add(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.verifyResource(..))",
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.updateResource(..)) " +
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.publish(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.verifyResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.suspend(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.auditResource(..))",
            returning = "serviceBundle")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.updateResource(..)) " +
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.publish(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.verifyResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.suspend(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.auditResource(..))",
            returning = "trainingResourceBundle")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.update(..)) " +
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.publish(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.verifyResource(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.suspend(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.auditResource(..))",
            returning = "interoperabilityRecordBundle")
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.ServiceBundleManager.delete(..))")
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.TrainingResourceManager.delete(..))")
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.InteroperabilityRecordManager.delete(..))")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.DatasourceManager.add(..))" +
            "|| execution(* gr.uoa.di.madgik.manager.DatasourceManager.verifyDatasource(..))",
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.DatasourceManager.update(..)) " +
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.DatasourceManager.verifyDatasource(..))",
            returning = "datasourceBundle")
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.DatasourceManager.delete(..))")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ResourceInteroperabilityRecordManager.add(..))",
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ResourceInteroperabilityRecordManager.update(..)) " +
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.ResourceInteroperabilityRecordManager.delete(..))")
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ConfigurationTemplateInstanceManager.add(..))",
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.ConfigurationTemplateInstanceManager.update(..)) " +
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.ConfigurationTemplateInstanceManager.delete(..))")
