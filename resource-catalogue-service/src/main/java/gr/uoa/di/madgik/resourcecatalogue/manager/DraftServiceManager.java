...
public class DraftServiceManager extends ResourceManager<ServiceBundle> implements DraftResourceService<ServiceBundle> {
    ...
    @Override
    public ServiceBundle updateDraft(ServiceBundle serviceBundle, Authentication authentication) throws NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
        return null;
    }
