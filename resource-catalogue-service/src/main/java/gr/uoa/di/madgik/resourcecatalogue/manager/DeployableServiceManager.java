...
//            commonMethods.createIdentifiers(deployableServiceBundle, getResourceTypeName(), true);
        ...
        NewProviderBundle providerBundle = providerService.get(deployableServiceBundle.getDeployableService().getResourceOrganisation(),
                deployableServiceBundle.getDeployableService().getCatalogueId());
...
//        ret.setMigrationStatus(existingDeployableService.getMigrationStatus());
    ...
    public DeployableServiceBundle verify(String id, String status, Boolean active, Authentication auth) {
        ...
        NewProviderBundle resourceProvider = providerService.get(deployableServiceBundle.getDeployableService().getResourceOrganisation(),
                deployableServiceBundle.getDeployableService().getCatalogueId());
    ...
    public DeployableServiceBundle audit(String deployableServiceId, String catalogueId, String comment,
        ...
        NewProviderBundle provider = providerService.get(deployableService.getDeployableService().getResourceOrganisation(),
                deployableService.getDeployableService().getCatalogueId());
//        emailService.notifyProviderAdminsForBundleAuditing(deployableService, provider.getProvider().get("users")); //FIXME
    ...
    public DeployableServiceBundle changeProvider(String resourceId, String newProviderId, String comment, Authentication auth) {
        ...
        NewProviderBundle oldProvider = providerService.get(deployableServiceBundle.getDeployableService().getResourceOrganisation(),
                deployableServiceBundle.getDeployableService().getCatalogueId());
