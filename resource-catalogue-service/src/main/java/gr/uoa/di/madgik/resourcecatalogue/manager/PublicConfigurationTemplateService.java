...
public class PublicConfigurationTemplateService
    ...
    public PublicConfigurationTemplateService(GenericResourceService genericResourceService,
    ...
    public void updateIdsToPublic(ConfigurationTemplateBundle bundle) {
        ...
        InteroperabilityRecordBundle interoperabilityRecordBundle = interoperabilityRecordService.get(
                (String) bundle.getConfigurationTemplate().get("interoperabilityRecordId"), bundle.getCatalogueId());
        bundle.getConfigurationTemplate().put("interoperabilityRecordId", interoperabilityRecordBundle.getIdentifiers().getPid());
    }
}
