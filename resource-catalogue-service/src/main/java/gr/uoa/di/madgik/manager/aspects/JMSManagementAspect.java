...
import gr.uoa.di.madgik.manager.PublicHelpdeskManager;
import gr.uoa.di.madgik.manager.PublicMonitoringManager;
import gr.uoa.di.madgik.utils.ObjectUtils;
import gr.uoa.di.madgik.utils.JmsService;
...
public class JMSManagementAspect {
    ...
    @Async
    @AfterReturning(pointcut = "(execution(* gr.uoa.di.madgik.manager.CatalogueManager.add(..)))" +
            "|| (execution(* gr.uoa.di.madgik.manager.CatalogueManager.verifyCatalogue(..)))",
    ...
    @Async
    @AfterReturning(pointcut = "(execution(* gr.uoa.di.madgik.manager.CatalogueManager.update(..)))" +
            "|| (execution(* gr.uoa.di.madgik.manager.CatalogueManager.update(..)))" +
            "|| (execution(* gr.uoa.di.madgik.manager.CatalogueManager.publish(..)))" +
            "|| (execution(* gr.uoa.di.madgik.manager.CatalogueManager.verifyCatalogue(..)))",
            returning = "catalogueBundle")
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.CatalogueManager.delete(..)))")
    ...
    @Async
    @AfterReturning(pointcut = "(execution(* gr.uoa.di.madgik.manager.HelpdeskManager.add(..)))",
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.HelpdeskManager.update(..)) " +
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.HelpdeskManager.delete(..)))")
    ...
    @Async
    @AfterReturning(pointcut = "(execution(* gr.uoa.di.madgik.manager.MonitoringManager.add(..)))",
    ...
    @Async
    @AfterReturning(pointcut = "execution(* gr.uoa.di.madgik.manager.MonitoringManager.update(..)) " +
    ...
    @Async
    @After("execution(* gr.uoa.di.madgik.manager.MonitoringManager.delete(..)))")
