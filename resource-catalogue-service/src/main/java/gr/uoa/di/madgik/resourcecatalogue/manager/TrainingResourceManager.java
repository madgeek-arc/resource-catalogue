...
//
//        ProviderBundle providerBundle = providerService.get(ret.getTrainingResource().getResourceOrganisation(),
...
//        ProviderBundle resourceProvider = providerService.get(trainingResourceBundle.getTrainingResource().getResourceOrganisation(),
...
//        ProviderBundle provider = providerService.get(trainingResource.getTrainingResource().getResourceOrganisation(),
...
//        ProviderBundle oldProvider = providerService.get(trainingResourceBundle.getTrainingResource().getResourceOrganisation(),
//                trainingResourceBundle.getTrainingResource().getCatalogueId());
//
