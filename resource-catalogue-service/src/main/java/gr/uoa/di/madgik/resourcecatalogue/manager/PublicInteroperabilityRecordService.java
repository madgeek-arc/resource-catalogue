...
public class PublicInteroperabilityRecordService
        extends AbstractPublicResourceManager<InteroperabilityRecordBundle>
    ...
    public PublicInteroperabilityRecordService(JmsService jmsService,
        ...
        super(InteroperabilityRecordBundle.class, jmsService, pidIssuer, facetLabelService);
