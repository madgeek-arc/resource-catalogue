...
@Profile("beyond")
@RestController
@RequestMapping(path = "public/catalogue", produces = {MediaType.APPLICATION_JSON_VALUE})
@Tag(name = "public catalogue")
public class PublicCatalogueController extends BasePublicController<CatalogueBundle> {
