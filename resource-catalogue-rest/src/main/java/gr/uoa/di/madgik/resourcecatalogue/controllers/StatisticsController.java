...
@Tag(name = "Statistics Controller", description = "Get information about KPIs usage statistics")
public class StatisticsController {
    ...
    //    @Operation(description = "Get visits per interval for a service.")
    ...
    //    @Operation(description = "Get addToProject per interval for a service.")
    ...
    //    @Operation(description = "Get aggregate visits per interval for all services offered by a provider.")
    ...
    //    @Operation(description = "Get aggregate 'addToProject per interval for all services offered by a provider.")
    ...
    //    @Operation(description = "Get percentage of visits for all services offered by a provider.")
    ...
    //    @Operation(description = "Providing the Provider's id, get the relation between all his services and their respective countries.")
    ...
    //    @Operation(description = "Get a relation between all Services and their Coordinating Country")
    ...
    //    @Operation(description = "Providing the Provider's id, get the relation between all his services and a specific Vocabulary")
    ...
    //    @Operation(description = "Get a list of places and their corresponding number of Services offered by the specified provider.")
    ...
    //    @Operation(description = "Get a list of places and their corresponding Services offered by the specified provider.")
    ...
    //    @Operation(description = "Get visits per interval for a datasource.")
    ...
    //    @Operation(description = "Get addToProject per interval for a datasource.")
