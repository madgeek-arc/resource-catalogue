...
public class StatisticsController {
    ...
    @GetMapping(path = "service/visits/{prefix}/{suffix}")
...
//        return new ResponseEntity<>(statisticsService.visits(id, by), HttpStatus.OK);
    ...
    @GetMapping(path = "service/addToProject/{prefix}/{suffix}")
    ...
    @GetMapping(path = "provider/visits/{prefix}/{suffix}")
...
//        throw new UnsupportedOperationException("Method has been removed");
    ...
    @GetMapping(path = "provider/addToProject/{prefix}/{suffix}")
    ...
    @GetMapping(path = "provider/visitation/{prefix}/{suffix}")
...
//        throw new UnsupportedOperationException("Method has been removed");
    ...
    @GetMapping(path = "provider/mapServicesToGeographicalAvailability")
    ...
    @GetMapping(path = "provider/mapServicesToProviderCountry")
    ...
    @GetMapping(path = "provider/mapServicesToVocabulary")
    ...
    @GetMapping(path = "provider/servicesPerPlace")
    ...
    @GetMapping(path = "provider/servicesByPlace")
    ...
    @GetMapping(path = "datasource/visits/{prefix}/{suffix}")
...
//        return new ResponseEntity<>(statisticsService.visits(id, by), HttpStatus.OK);
    ...
    @GetMapping(path = "datasource/addToProject/{prefix}/{suffix}")
    ...
    @Deprecated(forRemoval = true)
    @GetMapping(path = "trainingResource/visits/{prefix}/{suffix}")
...
//        return new ResponseEntity<>(statisticsService.visits(id, by), HttpStatus.OK);
    ...
    @GetMapping(path = "trainingResource/addToProject/{prefix}/{suffix}")
