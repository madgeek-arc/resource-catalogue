...
public class EventController extends ResourceController<Event> {
    ...
    public ResponseEntity<Event> setVisit(@PathVariable String id,
    ...
    @PreAuthorize("hasRole('ROLE_USER')")
    public ResponseEntity<Event> setAddToProject(@PathVariable String id,
    ...
    @PreAuthorize("hasRole('ROLE_USER')")
    public ResponseEntity<Event> setOrder(@PathVariable String id,
