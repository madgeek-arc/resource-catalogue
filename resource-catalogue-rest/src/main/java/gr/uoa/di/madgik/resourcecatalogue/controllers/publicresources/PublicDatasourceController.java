...
public class PublicDatasourceController extends BasePublicController<DatasourceBundle> {
    ...
    @Deprecated
    @GetMapping(path = "datasourceBundle/{prefix}/{suffix}")
    ...
    public ResponseEntity<Paging<DatasourceBundle>> getAllBundlesDeprecated(
