...
@Profile("beyond")
@RestController
@RequestMapping(path = "public/configurationTemplate", produces = {MediaType.APPLICATION_JSON_VALUE})
...
public class PublicConfigurationTemplateController extends BasePublicController<ConfigurationTemplateBundle> {
    ...
    @Operation(description = "Returns the Configuration Template Bundle with the given id.")
    @Override
    ...
    @Operation(description = "Get a list of all Public Configuration Templates in the Catalogue, based on a set of filters.")
    @Override
    @BrowseParameters
    @GetMapping(path = "all")
